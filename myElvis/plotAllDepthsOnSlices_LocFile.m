function plotAllDepthsOnSlices_LocFile(fsSub,elecInfoType,cfg)
...
% Get electrode info
if useLocFile
    % adding an option to read directly LocFile
    [elecMatrix, elecLabels, elecRgb] = csvElec2matlab(fsSub);

elseif strcmpi(elecInfoType,'BIDS-iEEG'),
    % BIDS-iEEG format
